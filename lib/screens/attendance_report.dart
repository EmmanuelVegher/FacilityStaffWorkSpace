      ...
      for (var staffDoc in staffSnapshot.docs) {
        ...
        for (var date = startDate; date.isBefore(endDate.add(Duration(days: 1))); date = date.add(Duration(days: 1))) {
          ...
          final recordSnapshot = await _firestore
              .collection('Staff')
              .doc(userId) // Now uses the userId from the loop
              .collection('Record')
              .doc(formattedDate)
              .get();
...
// Function to upload image to Firebase Storage
  ...
  <body>
    ...
    <p style="color:black; font-size:16px; font-weight:bold;">Attendance App Team.</p>
    ...
    Email: <a href="mailto:appsupport@ccfng.org">appsupport@ccfng.org</a> | Facebook: <a href="https://www.facebook.com/CaritasNigeria">www.facebook.com/CaritasNigeria</a><br>
    Website: <a href="https://www.caritasnigeria.org">www.caritasnigeria.org</a></p>
