...
class TimesheetDetailsScreen3 extends StatefulWidget {
...
// UPDATED METHOD
  Future<void> _uploadSignatureAndSync() async {
    ...
    // 1. Corrected Check: Ensure the supervisor trying to sign has uploaded their signature.
    if (selectedSignatureLink2 == null) {
      Fluttertoast.showToast(
        // Corrected Message: Informs the supervisor about their own signature.
