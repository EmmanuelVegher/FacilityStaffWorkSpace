    ...
    if (selectedSignatureLink == null) {
      if (checkSignatureImage.isNotEmpty) {
        ...
        if (selectedBioStaffCategory == "Facility Supervisor"){
          ...
          Fluttertoast.showToast(
            msg: "Cannot send timesheet without Caritas Supervisor's signature.",
            toastLength: Toast.LENGTH_LONG,
            backgroundColor: Colors.black54,
            gravity: ToastGravity.BOTTOM,
            timeInSecForIosWeb: 1,
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                child: staffSignature != 'N/A'?  CachedNetworkImage(
                                    ...
                                    if (facilitySupervisorSignature != null && facilitySupervisorSignatureStatus == "Approved") {
                                      return Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Flexible(
                                              child: CachedNetworkImage( // Use CachedNetworkImage here too
                                                imageUrl: facilitySupervisorSignature,
                                                placeholder: (context, url) => const CircularProgressIndicator(),
                                                errorWidget: (context, url, error) => const Icon(Icons.error),
                                                fit: BoxFit.contain,
                                              ),
                                ...
                                builder: (context, snapshot) {
                                  if (snapshot.hasData && snapshot.data!.exists) {
                                      ...
                                      return Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Flexible(
                                              child: CachedNetworkImage( // Use CachedNetworkImage here too
                                                imageUrl: caritasSupervisorSignature,
                                                placeholder: (context, url) => const CircularProgressIndicator(),
                                                errorWidget: (context, url, error) => const Icon(Icons.error),
                                                fit: BoxFit.contain,
                                              ),
                                    ...
                                    // ... (rest of the StreamBuilder logic for signature display and upload)
                                      ...
                                      return const Text("Awaiting Caritas Supervisor Signature");
                                    }
                                  } else {
                                    return const Text("Loading Signature Status...");
                                  }
